...
namespace MyAddressBookPlus
{
    public class AlwaysEncryptedInitializer
    {
        ...
        public static void InitializeAzureKeyVaultProvider()
        {
            ...
            //configure ADO.net to pass access token to Azure Key Vault, to get column master key(CMK)
            //use it decrypt a column encryption key(CEK), and in turn to encrypt and decrypt column data
